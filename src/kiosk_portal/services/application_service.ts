...
export const getListApplicationService = async (Name:any,PartyName:any,PartyEmail:any,AppCategoryName:any,Status:any, size: any,page: any) => {
  const response = await request.get(
    `${HOST}/v1/serviceApplications?Name=${Name}&PartyName=${PartyName}&PartyEmail=${PartyEmail}&AppCategoryName=${AppCategoryName}&Status=${Status}&size=${size}&page=${page}`
  );
