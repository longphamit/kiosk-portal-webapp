...
import {
  getKioskCommissionsByMonthService,
  getKioskCommissionsByYearService,
...
export const KioskLineChartComponent = ({ span }) => {
  ...
  const setHasData = (isYearChart, hasData) => {
    isYearChart ? setYearChartHasData(hasData) : setMonthChartHasData(hasData);
  };
      ...
      <Row>
        <Col span={12}>
          <SubKioskLineChartComponent
            ...
            chartTitle={
              "The Kiosks's Revenue Year " + currentTime.getFullYear()
            }
        ...
        <Col span={12}>
          <SubKioskLineChartComponent
            ...
            chartTitle={`The Kiosks's Revenue ${
              currentTime.getMonth() + 1
            }/${currentTime.getFullYear()}`}
