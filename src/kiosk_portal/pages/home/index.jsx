...
import { countAppService, countEventService, countKioskService, countPoiService } from "../../services/dashboard_service";
import "./styles.css"
                    ...
                    <Col span={6}>
                        {
                            countKiosk ?
                                <div className="count-chart-box">
                                    <h2>Kiosks</h2>
                                    {countKiosk.total != 0 ? <CountPieChart labels={labelCountKiosk} count={countKiosk} /> : null}
                    ...
                    <Col span={6}>
                        {
                            countEvent ?
                                <div className="count-chart-box">
                                    <h2>Event</h2>
                                    {countEvent.total != 0 ? <CountPieChart labels={labelCountEvent} count={countEvent} /> : null}
                                    <DashBoardPieChartInfor
                    ...
                    <Col span={6}>
                        {
                            countPoi ?
                                <div className="count-chart-box">
                                    <h2>POI</h2>
                                    {countPoi.total != 0 ? <CountPieChart labels={lableCountPoi} count={countPoi} /> : null}
                                    <DashBoardPieChartInfor
                                        activeTitle={"Active"}
            ...
            <Col span={6}>
                {
                    countApp ?
                        <div className="count-chart-box">
                            <h2>APP</h2>
                            {countApp.total != 0 ? <CountPieChart labels={lableCountApp} count={countApp} /> : null}
                            <DashBoardPieChartInfor
                                activeTitle={"Install"}
