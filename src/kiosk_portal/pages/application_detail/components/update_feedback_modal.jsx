...
import { getFeedbacksService, updateFeedbackService } from "../../../services/feedback_service";
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Avatar src="https://joeschmoe.io/api/v1/random" size='large' style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '20%', height: '20%', marginBottom: 10 }} />
                    < Row justify="center" align="center" style={{ marginBottom: 10 }}>
                        <span style={{ marginLeft: 20 }}>
                            <Rate tooltips={desc} onChange={setValue} value={value} allowClear={false} />
